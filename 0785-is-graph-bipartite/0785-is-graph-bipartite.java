class Solution {
    ...
    boolean dfs(int node,int col,int[] color,List<List<Integer>> adj)
    {
        ...
        for(int nbr : adj.get(node))
        {
            ...
            //if this curr node is prev colored and have color as same as the color that we have (col), then return false beacuse their cant be two adj nodes with same color  
